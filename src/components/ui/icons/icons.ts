export const Icons = {
  ...
  design: {
    paths: [
      {
        d: "M91.42,0v8.53h10.59v9.26H91.42v14.76l-9.26,3.73v-18.5H19.85v66.09h62.31V72.62l9.26-3.03v14.31h10.59v9.26H91.42v8.86h-9.26v-8.86H19.85v8.86h-9.26v-8.86H0v-9.26h10.59V17.79H0V8.53h10.59V0h9.26v8.53h62.31V0H91.42z",
      },
      {
        d: "M85.71,46.3c3.38,3.98,5.76,8.27,7.04,12.9l27.13-19.8c2.31-1.46,3.72-2.8,2.64-5.94c-0.65-0.99-1.42-1.6-2.31-1.84c-0.89-0.24-1.9-0.1-3.02,0.42L85.71,46.3z",
      },
      {
        d: "M44.95,76.48c8.2-3.73,18.63,4.06,24.92-4.01c1.67-2.14,2.57-5.34,1.99-8.13c-0.23-1.13-0.7-2.18-1.43-3.06c-0.33-0.39-0.7-0.75-1.13-1.08c-5.33-4.1-12.3-1.2-16.55,3.11C48.85,67.28,46.42,72.72,44.95,76.48z",
      },
      {
        d: "M72.45,57.41c1.55,1.27,3.48,4.03,3.55,6.65l14.44-3.7c-1.41-5.09-3.6-9.64-7.11-13.25C77.97,51.97,78.34,52.95,72.45,57.41z",
      },
      {
        d: "M56.85,46.06L45.16,58.8V39.44H34.15v-9.71h33.71v9.71H56.85z",
      },
    ],
    class: "h-8 w-8 flex-shrink-0 fill-current text-orange-500",
    width: 32,
  ...
  gmail: {
    paths: [
      {
        d: "M21.8 4H2.2A2.2 2.2 0 000 6.2v12.6A2.2 2.2 0 002.2 21h19.6a2.2 2.2 0 002.2-2.2V6.2A2.2 2.2 0 0021.8 4zm-.2 2l-9.2 7L3.4 6H21.6zM2 18V6.4l9.4 7.2a.5.5 0 00.6 0L22 6.4V18H2z",
      },
    ],
    class:
  ...
  linkedin: {
    paths: [
      {
        d: "M19.104 3H5.896A2.898 2.898 0 003 5.896v13.208A2.898 2.898 0 005.896 22h13.208A2.898 2.898 0 0022 19.104V5.896A2.898 2.898 0 0019.104 3zm-10.07 15.634h-2.73v-8.476h2.73v8.476zm-1.365-9.657a1.59 1.59 0 110-3.18 1.59 1.59 0 010 3.18zm12.02 9.657h-2.73v-4.332c0-1.033-.02-2.366-1.442-2.366-1.442 0-1.664 1.127-1.664 2.288v4.41h-2.73v-8.476h2.62v1.158h.038c.366-.694 1.258-1.426 2.592-1.426 2.772 0 3.284 1.825 3.284 4.198v4.546z",
      },
    ],
    class:
      "h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
  ...
  instagram: {
    paths: [
      {
        d: "M12.004 3.403c2.78 0 3.11.01 4.2.06 1.09.05 1.84.23 2.45.49.66.26 1.22.6 1.77 1.14.54.54.89 1.1 1.14 1.77.26.61.44 1.36.49 2.45.05 1.09.06 1.42.06 4.2s-.01 3.11-.06 4.2c-.05 1.09-.23 1.84-.49 2.45-.26.66-.6 1.22-1.14 1.77-.54.54-1.1.89-1.77 1.14-.61.26-1.36.44-2.45.49-1.09.05-1.42.06-4.2.06s-3.11-.01-4.2-.06c-1.09-.05-1.84-.23-2.45-.49-.66-.26-1.22-.6-1.77-1.14-.54-.54-.89-1.1-1.14-1.77-.26-.61-.44-1.36-.49-2.45-.05-1.09-.06-1.42-.06-4.2s.01-3.11.06-4.2c.05-1.09.23-1.84.49-2.45.26-.66.6-1.22 1.14-1.77.54-.54 1.1-.89 1.77-1.14.61-.26 1.36-.44 2.45-.49 1.09-.05 1.42-.06 4.2-.06m0-2.403c-2.85 0-3.21.01-4.33.06-1.12.05-1.88.24-2.55.51-.69.27-1.29.63-1.87 1.2-.57.57-.93 1.18-1.2 1.87-.28.67-.46 1.43-.51 2.55-.05 1.12-.06 1.48-.06 4.33s.01 3.21.06 4.33c.05 1.12.24 1.88.51 2.55.27.69.63 1.29 1.2 1.87.57.57 1.18.93 1.87 1.2.67.28 1.43.46 2.55.51 1.12.05 1.48.06 4.33.06s3.21-.01 4.33-.06c1.12-.05 1.88-.24 2.55-.51.69-.27 1.29-.63 1.87-1.2.57-.57.93-1.18 1.2-1.87.28-.67.46-1.43.51-2.55.05-1.12.06-1.48.06-4.33s-.01-3.21-.06-4.33c-.05-1.12-.24-1.88-.51-2.55-.27-.69-.63-1.29-1.2-1.87-.57-.57-1.18-.93-1.87-1.2-.67-.28-1.43-.46-2.55-.51-1.12-.05-1.48-.06-4.33-.06z",
      },
      {
        d: "M12 5.838c-3.403 0-6.162 2.76-6.162 6.162s2.76 6.162 6.162 6.162 6.162-2.76 6.162-6.162-2.76-6.162-6.162-6.162zm0 10.162c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4z",
      },
      {
        d: "M18.406 5.594c-.796 0-1.44.645-1.44 1.44s.645 1.44 1.44 1.44 1.44-.645 1.44-1.44-.645-1.44-1.44-1.44z",
      },
    ],
    class:
      "h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
  ...
  software: {
    paths: [
      {
        d: "M640-240h160v-80H640v80Zm-320-80h240v-80H320v80ZM640-400h160v-80H640v80Zm-320-80h240v-80H320v80ZM120-120v-720h720v720H120Zm80-80h560v-560H200v560Zm0 0v-560 560Z",
      },
    ],
  ...
  desktop: {
    paths: [
      {
        d: "M80-80v-60h800v60H80Zm200-120v-40l40-40H240q-33 0-56.5-23.5T160-360v-480q0-33 23.5-56.5T240-920h480q33 0 56.5 23.5T800-840v480q0 33-23.5 56.5T720-280H640l40 40v40H280ZM240-360h480v-480H240v480Zm0 0v-480 480Z",
      },
    ],
    class: "mt-1 h-8 w-8 flex-shrink-0 fill-orange-400 dark:fill-orange-300",
    width: 48,
